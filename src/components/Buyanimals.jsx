...
function Buyanimals() {
  ...
  useEffect(() => {
    const getAllNotes = async () => {
      // API Call
      const response = await fetch("http://localhost:5000/api/getAllPost", {
        method: "GET",
        headers: {
...
// </div>
// <div class="sort_filters col-lg-9 col-xs-12 col-sm-4" align="center"> <h2 align="center">Sort by Filters</h2>
// <form action="" method="post"> <div class="dropdown"> <select name="cat" id="cat" class="">
...
// </div><div class="dropdown"> <select name="price" id="price">
// <option value="" selected="selected">All</option>
// <option value="" selected="selected">Price</option>
// <option value="5000-15000">5000-15000</option>
// <option value="15000-30000">15000-30000</option>
// <option value="30000-50000">30000-50000</option>
// <option value="50000+">50000 Plus</option> </select> </div>

// <br></br>
// <div class="submit_btn1">
//  <NavLink to="/buyanimals">Clear Filter</NavLink>
//  {/* <div class="submit_btn1"> */}
